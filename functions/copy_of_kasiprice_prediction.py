# -*- coding: utf-8 -*-
"""Copy of [Kasi]Price Prediction.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1TKAiiDBFDqHvX6VnXIWt6YdOH5okzeHw
...
def cleanNewsData(coin_news_df):
    ...
    coin_news_df_sorted.drop(
        coin_news_df_sorted[coin_news_df_sorted["anger"] == "error"].index, inplace=True
    )
...
def getPriceData(coin_news_df, coin_name_binance):
    ...
    coin_price_df_raw = searchBinance(
